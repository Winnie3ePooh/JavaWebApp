...
public class ContactList {
    ...
    public JSONObject createDB() {
        ...
        try {
            ...
            st.execute("create table people(id INT PRIMARY KEY AUTO_INCREMENT, fio varchar(255))");
    ...
    public JSONArray list() {
        ...
        try {
            ...
            Statement st = conn.createStatement();
            ResultSet result = st.executeQuery("(SELECT * FROM PEOPLE ORDER BY id DESC LIMIT 3) ORDER BY id ASC");
    ...
    public JSONObject add(Contact c) {
        ...
        try {
            ...
            String q = "INSERT INTO PEOPLE(fio) VALUES(?)";
